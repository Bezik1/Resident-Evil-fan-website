...
export const useResource = (type : string) =>{
    ...
    const { flower, institution_1, arklay, europe_lab, info, grenland, spain, village } = RESOURCE_TYPES
    ...
    }, [type, flower, institution_1, arklay, europe_lab, obj, info, grenland, spain, village])
